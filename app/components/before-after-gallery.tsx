...
export default function BeforeAfterGallery({ projects, categories = [] }: BeforeAfterGalleryProps) {
  ...
  const handleMouseDown = (
    ...
    // Zabránit výchozímu chování prohlížeče
    return false
  }
          ...
          <div className="lg:col-span-2 order-1 lg:order-2">
            <Card className="overflow-hidden shadow-lg">
              <div
                ...
                onMouseDown={(e) => {
                  e.preventDefault()
                  handleMouseDown(containerRef, setSliderPosition)
                }}
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <DialogContent className="max-w-6xl p-0 overflow-hidden">
            ...
            <div
              ...
              className="relative h-[80vh] cursor-ew-resize select-none"
              onMouseDown={(e) => {
                e.preventDefault()
                handleMouseDown(fullscreenContainerRef, setFullscreenSliderPosition)
              }}
